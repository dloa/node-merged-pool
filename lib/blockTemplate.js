...
var BlockTemplate = module.exports = function BlockTemplate(jobId, rpcData, poolAddressScript, extraNoncePlaceholder, reward, txMessages, recipients, auxMerkleTree) {
    ...
    this.serializeCoinbase = function(extraNonce1, extraNonce2, callback) {
        transactions.CreateGeneration(
            rpcData,
            poolAddressScript,
    ...
    this.getJobParams = function(callback) {
        transactions.CreateGeneration(
            rpcData,
            poolAddressScript,
            extraNoncePlaceholder,
