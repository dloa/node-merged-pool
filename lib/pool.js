...
var pool = module.exports = function pool(options, authorizeFn){
    ...
    process.on('message', function(msg) {
        if (msg.type='dloaComment'){
            var unsigned = msg.dloaCommentUnsigned;
            _this.daemon.cmd('signmessage',
                ['FLmic78oU6eqXsTAaHGGdrFyY7FznjHfPU', unsigned],
                function (result) {
                    if (result.error) {
            ...
            console.log('Dloa comment signed: ', dloaCommentCache)
        }
    });
